...
const BLOCKED_PRODUCT_PACKAGES = new Set(['deepseek-desktop', '@deepseek-desktop/companion', '@deepseek-desktop/market', 'dsh-plugin-desktop', 'dsh-community-market'])
const DSH_RUNTIME_VERSION = '0.1.0-rc.6'
